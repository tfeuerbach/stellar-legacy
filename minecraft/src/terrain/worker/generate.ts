...
onmessage = (
  ...
  if (permSeed !== undefined) noise.setPermutation(permSeed)
  ...
  noise.gap = gap
  noise.amp = amp
  noise.treeHeight = treeHeight
  noise.treeThreshold = treeThreshold
  noise.stoneThreshold = stoneThreshold
  noise.coalThreshold = coalThreshold
  noise.seaLevel = seaLevel
